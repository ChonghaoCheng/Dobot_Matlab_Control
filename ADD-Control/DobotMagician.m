classdef DobotMagician < handle
   ...
   methods(Access = public)
       ...
       function PublishEndEffectorPose(self,pose,rotation)
           self.targetEndEffectorMsg.Position.X = (pose(1)+80)*0.001+0.157;
           self.targetEndEffectorMsg.Position.Y = (pose(2)-270)*0.001+0.024;
           self.targetEndEffectorMsg.Position.Z =-0.053;
       ...
       function InitPublishEndEffectorPose(self,pose,rotation)
