classdef DobotMagician < handle
   ...
   methods(Access = public)
       ...
       function PublishEndEffectorPose(self,pose,rotation)
           self.targetEndEffectorMsg.Position.X = pose(1)*0.005+0.2;
           self.targetEndEffectorMsg.Position.Y = pose(2)*0.005-0.09;
           self.targetEndEffectorMsg.Position.Z =-0.063;
       ...
       function PublishInitEndEffectorPose(self,pose,rotation)
           self.targetEndEffectorMsg.Position.X = pose(1)*0.005+0.2;
           self.targetEndEffectorMsg.Position.Y = pose(2)*0.005-0.09;
           self.targetEndEffectorMsg.Position.Z =pose(3)-0.063;
        ...
        function PublishInitEndEffectorPosetest(self,pose,rotation)
