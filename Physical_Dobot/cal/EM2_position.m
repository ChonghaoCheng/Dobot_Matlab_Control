function [Position] = EM2_position()
    ...
    Translation = [0 0 0];
    Translation(1) = EM_sensor_data.PortHandlePoses(2).Translation.X;
    Translation(2) = EM_sensor_data.PortHandlePoses(2).Translation.Y;
    Translation(3) = EM_sensor_data.PortHandlePoses(2).Translation.Z;
